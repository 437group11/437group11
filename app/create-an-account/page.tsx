    ...
    return (
        <>
            ...
            <form className="mt-8">
                ...
                <button type="submit" href="/feed" className="p-4 bg-accent-brown text-white py-2 rounded-md hover:bg-accent-brown-darker focus:outline-none focus:ring-4 focus:ring-accent-blue">Create</button>
            </form>
        </>
    )
}
