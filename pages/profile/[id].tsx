            ...
            <SimpleGrid color={"white"} spacing='20px' columns={[1, 2, 3, 4]} p={5}>
                {albums.map((review, index) => (
                    <Box key={index} onClick={() => {
                        router.push(`/album/${review.album.spotifyId}`)
                    }}>
                                ...
                                <UnorderedList
                                    ...
                                    {usersReturned.map((user: User) => (
                                        <ListItem
                                            ...
                                            <Img id="userImage" flex="1" maxW="60px" borderRadius="full"
                                                 src={user.image ?? "default-user-icon.png"}/>
                                            <Text fontSize="l" fontWeight="bold" flex="2" borderRadius="0" ml={5}
